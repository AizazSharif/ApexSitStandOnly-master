...
import com.example.aizaz.mainapexsitstand.db.ToursDataSource;
import com.example.aizaz.mainapexsitstand.model.Tour;
...
//        textStatus.setText("Attached.");
    ...
    private Button Home,History,Cloud, SetDay;
    GPSTracker gps;
boolean gpsNotSetFlag= true;
    int value,countWalk,countRun,countUps,countDowns,countStand,countSit=0;
    int countIdle=10;
...
///////////////////////////////////////////////////////
        ...
        progress1.setProgressColor(Color.parseColor("#1b6be0"));
        progress1.getProgressColor();
        progress2.setProgressColor(Color.parseColor("#8e44ad"));
    ...
    public void setpie(){
        ...
        mPieChart.addPieSlice(new PieModel("Sitting", pieSit, Color.parseColor("#1b6be0")));
        mPieChart.addPieSlice(new PieModel("Standing", pieStand, Color.parseColor("#8e44ad")));
...
///////////////////////////////////////
    ...
    public void uiUpdate(String v){
        ...
        if(v.equals(si)){
            ...
            progress1.setProgress(countSit);
        ...
        if(v.equals(st)){
            countStand++;
            progress2.setProgress(countStand);
            pieStand++;
        }
